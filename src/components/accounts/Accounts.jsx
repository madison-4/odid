...
function PortalSignup({ operations }) {
  const {
    allCountyData,
    allConstData,
    allWardData,
  ...
  return (
    <>
      <>
        <Grid sx={{ mt: { xs: 2, lg: 0, md: 0 } }} container>
          <Grid
            item
            xs={12}
            md={6}
          ...
          >
            <Container>
              <OfficialsForm operations={operations} />
            </Container>
          </Grid>
          <Grid item xs>
            <Box>
              <Map className="AgentSignup">
                ...
                <AtlasMap
                  ...
                  datatype="ward"
                />
                {operations && <PublicLocationMarker />}
